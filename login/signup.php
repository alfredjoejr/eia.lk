...
<body>
    ...
    <div class="container">
        <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
            <a href="index.php" class="text-sm text-blue-600 hover:text-blue-800 hover:underline font-medium flex items-center gap-1">
                        <i class="uil uil-arrow-left"></i> Login
            </a>
            <a href="../Mentor/index.php" class="flex items-center gap-3 hover:opacity-80 transition-opacity" title="Go to Homepage">
                <img src="./img/eia.png" alt="EIA Logo" class="h-10 w-10 object-contain rounded-full shadow-sm">
                <div class="hidden sm:block text-left">
                    <h4 class="text-sm font-bold text-gray-900 leading-tight">Education Incentive</h4>
                    <h4 class="text-sm font-bold text-gray-900 leading-tight">Association</h4>
                </div>
            </a>
        
            <div class="flex items-center gap-4">

                <h1 class="text-1xl font-bold text-gray-800 m-0 p-0 tracking-wide">Sign Up</h1>
            </div>
        </div>
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="tel" name="wano" id="wano" maxlength="10" placeholder="07XXXXXXXX" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
                ...
                <div class="details ID">
                    ...
                    <div class="fields">
                        <div class="input-field">
                            ...
                            <input type="text" name="nic" id="nic" maxlength="12" placeholder="200xxxxxxxxx" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                        </div>
                    ...
                    <div class="flex items-start mb-4">
                        ...
                        <input id="terms" name="terms" type="checkbox" value="agreed" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300" required>
                        </div>
                        <label for="terms" class="ms-2 text-sm font-medium text-gray-900">I agree with the <a href="https://www.termsfeed.com/live/13070a4f-0614-4c23-acc0-0884268c53f8" class="text-blue-600 hover:underline">terms and conditions</a></label>
                    </div>
