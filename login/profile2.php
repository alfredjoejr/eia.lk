  ...
  <div class="min-h-screen p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg col-span-1 flex flex-col items-center">
        ...
        <h2 class="text-2xl font-bold text-gray-800 mt-4 text-center">
        ...
        <p class="text-gray-600 text-sm font-medium text-center">
          ...
          <div class="mt-6 flex flex-col w-full gap-3">
            ...
            <a href="https://wa.me/+447466058267" class="inline-flex items-center justify-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-200 shadow-sm">
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg col-span-1">
        ...
        <div class="mb-6 space-y-3 text-sm text-gray-800">
            ...
            <span>
            <?= !empty($user["member_id"]) ? htmlspecialchars($user["member_id"]) : 'Pending' ?>
            </span>
        </div>
          <div class="flex justify-between items-center">
        ...
        <div class="flex justify-between items-start">
          <span class="font-semibold text-gray-600 shrink-0">Course</span>
          <span class="text-right ml-4"><?= htmlspecialchars($user["course"]) ?></span>
        </div>
          <div class="flex justify-between items-center">
    ...
    <div class="flex justify-between items-center">
          ...
          ?>
            <div class="flex items-center gap-2">
              ...
              <a href="#" id="bankDetailsBtn" class="inline-flex items-center px-3 py-1 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-sm">
                <i class="ri-bank-card-line mr-1"></i> Payment
              </a>
      ...
      if (updateBtn) {
        updateBtn.addEventListener('click', function(e) {
          ...
          Swal.fire({
            ...
            html: `<p class="mb-4 text-gray-700">Contact Admin.</p>`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
              window.location.href = 'https://wa.me/+447466058267';
            }
          });
        });
      }
        ...
        verifyBtn.addEventListener('click', function(e) {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              // 
              window.location.href = 'https://wa.me/+447466058267'; // (Example: https://wa.me/94771234567)
            }
          });
        });
      }
// --- 4. UPDATED: Code for "Bank Details" Button Popup with Important Message ---
      ...
      if (bankDetailsBtn) {
        bankDetailsBtn.addEventListener('click', function(e) {
          ...
          Swal.fire({
            ...
            html: `
              <div class="text-left text-gray-700 space-y-3 mt-4 bg-blue-50 p-4 rounded-lg border border-blue-100 text-sm">
                <div class="flex justify-between border-b border-blue-200 pb-2">
                  <strong class="text-blue-900">Account Name:</strong> 
                  <span class="text-right">Education Incentive Association</span>
                </div>
                <div class="flex justify-between border-b border-blue-200 pb-2">
                  <strong class="text-blue-900">Account Number:</strong> 
                  <span class="font-mono text-blue-700 font-bold">93174298</span>
                </div>
                <div class="flex justify-between border-b border-blue-200 pb-2">
                  <strong class="text-blue-900">Bank Name:</strong> 
                  <span class="text-right">Bank of Ceylon</span>
                </div>
                <div class="flex justify-between">
                  <strong class="text-blue-900">Branch:</strong> 
                  <span class="text-right">Batticaloa Branch</span>
                </div>
              </div>

              <div class="mt-4 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg text-left">
                <p class="text-amber-900 text-xs leading-relaxed">
                  <i class="ri-error-warning-fill mr-1 text-amber-600 text-sm"></i>
                  <strong>IMPORTANT:</strong> Please use your User ID (<strong><?= !empty($user["member_id"]) ? htmlspecialchars($user["member_id"]) : 'Pending' ?></strong>) as the transaction reference. 
                  You <strong>MUST</strong> send the payment receipt to the WhatsApp number by pressing the <strong>"Verify"</strong> button on your profile.
                </p>
              </div>

              <div class="text-left text-gray-700 space-y-2 mt-4 bg-green-50 p-4 rounded-lg border border-green-100 text-sm">
                <h4 class="font-bold text-green-900 border-b border-green-200 pb-1 mb-2">Membership Fees</h4>
                <div class="flex justify-between pb-1 border-b border-green-200 border-opacity-50">
                  <strong class="text-green-800">Pre-University Members:</strong> 
                  <span class="font-mono text-green-700 font-bold">Rs. 500/=</span>
                </div>
                <div class="flex justify-between pb-1 border-b border-green-200 border-opacity-50">
                  <strong class="text-green-800">Undergraduate:</strong> 
                  <span class="font-mono text-green-700 font-bold">Rs. 500/=</span>
                </div>
                <div class="flex justify-between pb-1 border-b border-green-200 border-opacity-50">
                  <strong class="text-green-800">Graduate:</strong> 
                  <span class="font-mono text-green-700 font-bold">Rs. 2,500/=</span>
                </div>
                <div class="flex justify-between">
                  <strong class="text-green-800">Lifetime (Graduates):</strong> 
                  <span class="font-mono text-green-700 font-bold">Rs. 12,500/=</span>
                </div>
              </div>
            `,
            icon: 'info',
            ...
            customClass: {
              confirmButton: 'bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded'
            },
            buttonsStyling: false
          });
        });
...
<footer class="mt-8 pb-4 text-center text-sm text-gray-600">
    <p>
      &copy; Copyright EIA 2026, Developed by 
      <a href="https://instagram.com/alfredjoejr" target="_blank" rel="noopener noreferrer" class="text-blue-600 font-semibold hover:underline transition-colors duration-200">
        Joash Jeshurun
      </a>
    </p>
  </footer>
